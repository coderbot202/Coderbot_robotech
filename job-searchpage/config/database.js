...
const connectDB = async () => {
    try {
        ...
        const mongoURI = process.env.MONGODB_URI || 'mongodb+srv://manankhandelwal2020:ZnIEPKoRE3X034Z0@cluster1.mbd3gqb.mongodb.net/jobportal?retryWrites=true&w=majority&appName=Cluster1';
